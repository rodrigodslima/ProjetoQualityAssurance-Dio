...
describe("Testes automatizados com cypress Sprint 2", () => {
    ...
    it('Testar a funcionalidade da opção de buscar produtos de A a Z', () => {
    ...
    it('Testar a funcionalidade da opção de buscar produtos de Z a A', () => {

        cy.get('[data-test=username]').type("standard_user").should("have.value","standard_user")
        cy.get('[data-test=password]').type("secret_sauce").should("have.value","secret_sauce")
        cy.get('#login-button').click()
        cy.get('.product_sort_container').select('za').should('contain','Name (Z to A)')

    }) 

    it('Testar a funcionalidade da opção de buscar produtos pelo preço mais baixo', () => {
    ...
    it('Testar a funcionalidade da opção de buscar produtos pelo preço mais alto', () => {
