...
describe("Testes automatizados com cypress Sprint 3", () => {
    ...
    it('Testar a funcionalidade de cadastrar endereço',() => {
    ...
    it('Testar a funcionalidade de cadastrar endereço sem dados cadastrados',() => {
    ...
    it('Testar a funcionalidade de efetivar compras na loja virutal', () => {
    ...
    it('Testar funcionalidades da opção todos os itens', () => {
    ...
    it('Testar funcionalidades das opção sair', () => {
