...
it("(QA-TC-2)Teste login senha inválida", () => {
...
it("(QA-TC-3)Clicar no produto da loja virtual ver as informações do produto e clicar no botão voltar para página anterior", () => {
...
it("(QA-TC-11)Verificar funcionalidade do botão adicionar e remover", () => {
